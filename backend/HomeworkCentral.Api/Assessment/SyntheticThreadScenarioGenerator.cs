...
public sealed class SyntheticThreadScenarioGenerator(ILlmClient llm)
{
    ...
    private static SyntheticThreadScenario CreateFallback(NeuralTrainingMode mode)
    {
        ...
        IReadOnlyList<SyntheticThreadMessage> messages = tutoring
            ...
            : [
                new(0, "synthetic-reported", "student", "general", "You are such a damn idiot. Stop talking.", false, 1f, new(.05f, 34, .15f, ["reported profanity"]), .95f, 1f, .05f, .9f),
                new(1, "synthetic-peer", "student", "general", "Please keep the conversation respectful.", true, .35f, new(.8f, 18, .1f, ["de-escalation"]), .5f, .35f, .8f, .7f),
                ...
                new(3, "synthetic-reported", "student", "general", "This is stupid as hell and I do not care.", false, 1f, new(.08f, 28, .1f, ["continued profanity"]), .92f, 1f, .08f, .88f)];
