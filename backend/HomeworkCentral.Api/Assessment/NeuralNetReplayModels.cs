...
// V2 replay / promotion JSON shapes for admin training downloads and the frontend viewer.
// Schema + import limits: NeuralNetReplaySerializer and frontend/src/utils/neuralNetReplay.ts.
// See docs/tickets.md.
...
/// <summary>Deduplicated string pool; many payload fields store indices into <see cref="Values"/>.</summary>
...
/// <summary>
/// Logits are clamped before JSON serialization so ±Infinity cannot mark a session Failed
/// (<c>System.Text.Json</c> rejects non-finite floats by default).
/// </summary>
...
/// <summary>Packed float32 weights (Base64) plus checksum used for promotion / canonical publish.</summary>
