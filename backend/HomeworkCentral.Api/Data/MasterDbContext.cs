...
public class MasterDbContext(DbContextOptions<MasterDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder mb)
    {
        mb.Entity<Tenant>(e =>
        {
            ...
            e.Property(t => t.Slug).HasMaxLength(32).IsRequired();
            e.HasIndex(t => t.Slug).IsUnique();
            e.Property(t => t.DisplayName).HasMaxLength(128).IsRequired();
            e.Property(t => t.DeveloperEmail).HasMaxLength(320).IsRequired();
            e.HasIndex(t => t.DeveloperEmail).IsUnique();
            e.ToTable(t => t.HasCheckConstraint("CK_Tenants_DeveloperEmail_Lower", "\"DeveloperEmail\" = lower(\"DeveloperEmail\")"));
